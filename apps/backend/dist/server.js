...
var notification_route_1 = __importDefault(require("./routes/notification.route"));
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (env_1.ENV.NODE_ENV !== "production") {
                    app.listen(env_1.ENV.PORT, function () { return console.log("Server is up and running on Port", env_1.ENV.PORT); });
                }
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                console.log("Failed to start Server", error_1);
                process.exit(1);
                return [3 /*break*/, 3];
